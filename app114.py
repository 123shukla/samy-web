...
excel_data_df = pandas.read_excel('Book1.xlsx', sheet_name='Sheet114')
...
layout = html.Div([
    html.H3(('Bedroom-1 (Node 114)'),style={'textAlign': 'center'}),
    html.Div([
         dcc.Dropdown(
            id='xaxis114',
...
@app.callback(Output('graph22', 'figure'),
              [Input('xaxis114', 'value')])

## Main Plotting Function

def update_graph(xaxis114_name):
    return {
           'data': [go.Scatter(
            x=excel_data_df['Date'],
            y=excel_data_df[xaxis114_name],
        ...
        'layout': go.Layout(
            ...
            yaxis={'title': xaxis114_name.title()},
            title="Line Plot",
...
@app.callback(Output('graph23', 'figure'),
              [Input('xaxis114', 'value')])
...
def update_graph(xaxis114_name):
    return {
        ...
        'layout': go.Layout(
            xaxis={'title': xaxis114_name.title()},
